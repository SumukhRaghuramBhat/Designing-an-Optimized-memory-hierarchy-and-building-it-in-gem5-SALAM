...
void top(uint64_t REAL_addr,
	...
	volatile uint8_t  * FFTVar0  = (uint8_t *)(FFT+1);
	volatile uint8_t  * FFTVar1  = (uint8_t *)(FFT+9);
	volatile uint8_t  * FFTVar2  = (uint8_t *)(FFT+17);
	volatile uint8_t  * FFTVar3  = (uint8_t *)(FFT+25);
